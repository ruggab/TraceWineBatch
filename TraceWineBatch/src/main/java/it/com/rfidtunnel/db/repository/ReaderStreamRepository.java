...
public interface ReaderStreamRepository extends JpaRepository<ReaderStream, Long> {
	...
	@Query(value = "select distinct  a.id_tunnel as idTunnel, a.package_data as packageData,  a.tid  from reader_stream a  where  a.package_data= ?1 order by a.pack_id desc  ", nativeQuery = true)
